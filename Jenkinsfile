      ...
      steps {
        ...
        withSonarQubeEnv(credentialsId: 'sonarqube', installationName: 'sonarqube')
           {    withMaven{
                  ...
                  sh 'mvn clean package sonar:sonar -Dsonar.host.url=http://13.66.154.93:9000 -Dsonar.sources=. -Dsonar.tests=. -Dsonar.inclusions=**/test/java/servlet/createpage_junit.java -Dsonar.test.exclusions=**/test/java/servlet/createpage_junit.java -Dsonar.login=admin -Dsonar.password=admin' 
                  }
                }
      }
    }
